...
Feature: View the quiz being due
  ...
  Scenario: View my quizzes that are due
    ...
    Then I should see "You have quizzes that are due" in the "My Courses" "block"
    And I should see "Quiz 1C Future deadline" in the "My Courses" "block"
    And I should see "Quiz 1D Future deadline" in the "My Courses" "block"
    And I should see "Quiz 1E Future deadline" in the "My Courses" "block"
    And I should not see "Quiz 1A No deadline" in the "My Courses" "block"
    And I should not see "Quiz 1B Past deadline" in the "My Courses" "block"
    And I should not see "Quiz 2A Future deadline" in the "My Courses" "block"
    And I log out
    And I log in as "student2"
    And I press "Customise this page"
    And I add the "My Courses" block
    And I should see "You have quizzes that are due" in the "My Courses" "block"
    And I should not see "Quiz 1C Future deadline" in the "My Courses" "block"
    And I should not see "Quiz 1D Future deadline" in the "My Courses" "block"
    And I should not see "Quiz 1E Future deadline" in the "My Courses" "block"
    And I should not see "Quiz 1A No deadline" in the "My Courses" "block"
    And I should not see "Quiz 1B Past deadline" in the "My Courses" "block"
    And I should see "Quiz 2A Future deadline" in the "My Courses" "block"
